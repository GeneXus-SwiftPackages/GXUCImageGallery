...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.1.0-beta.8.xcframework.zip",
			checksum: "a1272efdf0e49634b4f351e1a3a943da73c41a2a26cbc68f42bd0c44cb4e9d4f"
		)
	]
)