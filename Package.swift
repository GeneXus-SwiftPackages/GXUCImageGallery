...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230428131619.xcframework.zip",
			checksum: "8fb200d720a2288f2cd7a55c6e37cb67e389c4d672aaad4aa489031073e5fec2"
		)
	]
)