...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "a78709edac74e5f364e9e98ab445fcfedc75ce5d4d5983e24cab1504540f3db6"
		)
	]
)