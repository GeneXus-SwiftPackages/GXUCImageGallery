...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230503140111.xcframework.zip",
			checksum: "1f5915dc91987a57c5771a2d6b407d9beeea7b829ab583fccc0262437ee81d4d"
		)
	]
)