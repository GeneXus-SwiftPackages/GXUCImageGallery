...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230228111720.xcframework.zip",
			checksum: "d295e63ae854bc862132156959cb57bf06161f17ae77a967070cb944f21998f9"
		)
	]
)