...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230316174639.xcframework.zip",
			checksum: "f1e3c228ca8084bcb68ffd0c40507bcb5157c757664505f328f398e4b4c98bbd"
		)
	]
)