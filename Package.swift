...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230509112137.xcframework.zip",
			checksum: "b9b1e654618e5d2daccfa67c161066524b4b65a7490c82cf2315869bee0c3468"
		)
	]
)