...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230505123704.xcframework.zip",
			checksum: "b7bb2b5111b1343f1e0063fe4f079e519ca174b962506293a353411bc93f043b"
		)
	]
)