...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230503131704.xcframework.zip",
			checksum: "c5ba9827a5e8f8772e76603fc371784f6d4c7f915d85e004e1fe6bb122c1bbcf"
		)
	]
)