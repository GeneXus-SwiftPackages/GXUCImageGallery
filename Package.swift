...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230420132651.xcframework.zip",
			checksum: "751fc626bbb6a6190a198b8f379da9be5b40e5b5deea92512fb48859fb7dc208"
		)
	]
)