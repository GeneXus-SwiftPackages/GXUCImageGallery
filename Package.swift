...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230306135613.xcframework.zip",
			checksum: "77d67dad1964c9bde02b111e98c74da846fd6591a2267ad2ba23f97885ba1417"
		)
	]
)