...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230418130717.xcframework.zip",
			checksum: "bd908ea5be5198604a35328e25c4058eb14064b25ee7512939bdf4a8ac1e1a0c"
		)
	]
)