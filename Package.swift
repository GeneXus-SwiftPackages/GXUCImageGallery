...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta.20230614190626.xcframework.zip",
			checksum: "67eb76a565199e3608afc650ba3af778747cc860f14fe53d0e6c4b0123419c14"
		)
	]
)