...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230601044120.xcframework.zip",
			checksum: "0f78c702b576f2be40148dedf6eb6a3c118455861c8bd45c8edf49f46fada6ba"
		)
	]
)