...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230524184838.xcframework.zip",
			checksum: "afafd4a4da21037e225d2d5b8c67f0b9b2b8dc7fe86db5fe3c1cfc04281658a1"
		)
	]
)