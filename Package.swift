...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230515023341.xcframework.zip",
			checksum: "9bd090c77de41d8e3b6c0f05057a80d3dd94b27d7bf9f949d233d6526842283d"
		)
	]
)