...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230316142352.xcframework.zip",
			checksum: "9c6c33e0008bdd981d2d994894d8b25354893430e88c1e4776dd78aaabd7d03c"
		)
	]
)