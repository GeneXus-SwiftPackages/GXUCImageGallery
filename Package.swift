...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230309171424.xcframework.zip",
			checksum: "7dabeaedc157806481d2f4364c66dd2da529bf72ab6696a31809e802966e3602"
		)
	]
)