...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230509202229.xcframework.zip",
			checksum: "ad3d64a6e309ce3fe78a7e68e1c8b012ab12f4e1e317f62fc5d463ba10ef6960"
		)
	]
)