...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230309092859.xcframework.zip",
			checksum: "ddd0b91b493a937528332073e15ed6841e683b5415b8d3b75cfe36b3e5a8b73a"
		)
	]
)