...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230309142042.xcframework.zip",
			checksum: "27163db373856ca7c616bc07f9af3f711556741df5809a6ffe58b212ede78c45"
		)
	]
)