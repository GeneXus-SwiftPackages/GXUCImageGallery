...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230531050040.xcframework.zip",
			checksum: "d37f83dbf174e7e2302a6ca2fb7046092a0ef76cd5de1aca9f155e48151af373"
		)
	]
)