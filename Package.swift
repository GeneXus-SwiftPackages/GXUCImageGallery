...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta.20230615110131.xcframework.zip",
			checksum: "56cdbd918b458eff9468eaec59242f20d73b7eb0f86ef244b50aaedd0ea42238"
		)
	]
)