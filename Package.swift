...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230525122919.xcframework.zip",
			checksum: "a5393eb9b2f049df13bcd14f65cb77423812c2ffd9d74d2fe9f9ae8123fb8a9d"
		)
	]
)