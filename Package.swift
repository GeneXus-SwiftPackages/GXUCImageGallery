...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230504180356.xcframework.zip",
			checksum: "641e033159224b926b1286f6d08948952ede9edd59df0f0747d0f509e7770ffd"
		)
	]
)