...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230302113401.xcframework.zip",
			checksum: "89ece12212586446cbba27164a5a9450d704d0faf5a355435796548fbbae2416"
		)
	]
)