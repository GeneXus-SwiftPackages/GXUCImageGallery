...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230307184249.xcframework.zip",
			checksum: "fd1f6ef3c9b03693eaea15074c3972d6e007f1b1b11a8e5e270f0fbbeb55779e"
		)
	]
)