...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230303092649.xcframework.zip",
			checksum: "54918742fe3736589664184a4ca27d460f9ad8ed8f0bf16a141ae6003dc71ced"
		)
	]
)