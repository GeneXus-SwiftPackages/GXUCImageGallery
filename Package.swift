...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta.20230630204809.xcframework.zip",
			checksum: "636b27138d8cf1e6bda3da7477bca503049a9486f353855957ce248908aad15d"
		)
	]
)