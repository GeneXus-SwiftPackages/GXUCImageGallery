...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230515174624.xcframework.zip",
			checksum: "d4c060e8d9f13b8b999c2c335bfa3b1c7641d7149f0e4a611f6ff8795a7fa68f"
		)
	]
)