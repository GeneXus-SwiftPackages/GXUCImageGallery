...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta.20230717155910.xcframework.zip",
			checksum: "4b9b8dd248022a7d2103df23a8e78dca4da53c77390e39ca3d3f3cfeefbaf333"
		)
	]
)