...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230518171417.xcframework.zip",
			checksum: "dc8234d47f8d83e6e3940550e5e3444c82383dadf5a1505fd27d66d6776ebf3a"
		)
	]
)