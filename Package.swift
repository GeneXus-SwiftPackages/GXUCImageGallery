...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230405133406.xcframework.zip",
			checksum: "679549bb90a894bc2997e409a3b50dc24ab6643186812a2803feb164f1c21400"
		)
	]
)