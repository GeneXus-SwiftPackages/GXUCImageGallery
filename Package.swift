...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230424185248.xcframework.zip",
			checksum: "cd9ba76c253907440fca3dbc04839ac8270757a66b2e90bc65983c8ad1fbe319"
		)
	]
)