...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta.20230714111921.xcframework.zip",
			checksum: "4df61d57d7c5267715b83e122f465128fe6de77ca666896e1ccfa9e94bc87919"
		)
	]
)