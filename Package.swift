...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta.20230721115743.xcframework.zip",
			checksum: "964efdff0bbf1f51999a34d541d0b01be20cd524ce238d1f08a98ad13937f40f"
		)
	]
)