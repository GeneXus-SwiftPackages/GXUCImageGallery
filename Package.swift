...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230309150554.xcframework.zip",
			checksum: "e325139a66d0cb5a60fa2f11c4584d9f15f1276db58b4f0fc10bdfb378636e51"
		)
	]
)