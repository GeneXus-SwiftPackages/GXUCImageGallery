...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230505145632.xcframework.zip",
			checksum: "996a7fecebbf6cb61b1248b62916be0ec5d575b34988f31da19713237757e30c"
		)
	]
)