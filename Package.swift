...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230502131235.xcframework.zip",
			checksum: "86ebb5adae92ee6b81513a4b7668de6fd62a2970f9522ab641f7e1092b9f85ea"
		)
	]
)