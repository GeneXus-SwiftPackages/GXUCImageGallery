...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230509173316.xcframework.zip",
			checksum: "6522858114ddede17860fb2bf234e4fa3f4eefd3632d64fb90c1ed9c6fd66df4"
		)
	]
)