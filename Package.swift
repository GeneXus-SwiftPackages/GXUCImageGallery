...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta.20230724135409.xcframework.zip",
			checksum: "98516a4b2857f5e41a9a28d89a247a9a9405421f1061cb888bfcfee5d6b91098"
		)
	]
)