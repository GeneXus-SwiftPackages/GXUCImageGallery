...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230323104412.xcframework.zip",
			checksum: "ac91d2afc87b6d9c300929aabdaead0d6c63480dd1500d4a2477453da71a48c5"
		)
	]
)