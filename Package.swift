...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230306155445.xcframework.zip",
			checksum: "7f69c5d400efc6e147ac7018fce8f2680e15ba70ea2e85738d9efe6b4afe9bc0"
		)
	]
)