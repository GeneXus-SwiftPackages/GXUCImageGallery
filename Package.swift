...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230328162416.xcframework.zip",
			checksum: "3af722f712b98391a67fca77c25a10ff792d7e3d396efaef53dc5ca14818e43a"
		)
	]
)