...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230323132058.xcframework.zip",
			checksum: "dd8d4fc6c200a5da0936a75d3efdeb4ca8a99d9f0bb7ff5034953807b2fc14eb"
		)
	]
)