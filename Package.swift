...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230525135158.xcframework.zip",
			checksum: "fb4c141723cf3053c404ba7261178b68bfd5c328d92f28f1d99e391f1f5b38b5"
		)
	]
)