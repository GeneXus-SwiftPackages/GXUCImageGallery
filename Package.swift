...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230428202437.xcframework.zip",
			checksum: "6dbf7ad510635569839d7439c46212844b5f24d3fa420cf0f8407ca8a8cf80df"
		)
	]
)