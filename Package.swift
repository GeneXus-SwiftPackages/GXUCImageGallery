...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230315120127.xcframework.zip",
			checksum: "4c120e5861bbf86de7336a19893f84232062c0bcf228cb22be034dfbcfda2b7d"
		)
	]
)