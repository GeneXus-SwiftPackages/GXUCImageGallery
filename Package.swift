...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCImageGallery",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCImageGallery-1.0.0-beta+20230309100338.xcframework.zip",
			checksum: "076f2b74111fd44842b236f33eddb6a96bfa972d08acaa5fc5a54bc2a5c78323"
		)
	]
)